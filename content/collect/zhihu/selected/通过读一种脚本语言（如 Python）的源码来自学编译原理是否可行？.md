...
另同样推荐楼上的那本Understanding Computation（《计算的本质》，但是建议看英文原版），一本step by step把那些理论性的东西具象出来的书。只是没有涉及太多跟parsing相关的内容，另结合一些别的书籍会更好。~~（比如 [@vczh](https://www.zhihu.com/people/0970f947b898ecc0ec035f9126dd4e08) 通常推荐的 Parsing Techniques（雾~~

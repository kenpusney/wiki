...
同样的转到[隔壁的问题](http://www.zhihu.com/question/26751127)（[[现代编程语言需要具备什么要素？]]），C++几乎具备了答案中提到的全部要素，所谓的感觉C++变得老旧不堪，要么是没有看过[*真正*](https://gac.codeplex.com/SourceControl/latest)的C++代码，要么就是被DSL给惯坏了。 [@vczh](https://www.zhihu.com/people/0970f947b898ecc0ec035f9126dd4e08)给了我们一套近乎完美的实例，无论是学习还是使用能让你体会到C++究竟是什么样子的。

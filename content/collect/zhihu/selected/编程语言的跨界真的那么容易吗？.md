...
你去翻一翻Yesod的教程[^3]就能开心地用**Haskell**写Web应用了，不需要理解什么是Monad。
...
3. "通过Yesod学习Haskell的路子"是指先简单入门一门语言，然后选取一个基于该语言的框架直接去做应用；至少看起来你可以用该语言做出东西来，也算是一种“学会”。就像大部分Java程序员虽然功底不如RFX，依然可以开心地用Java EE一样。（Yesod是一个基于Haskell的Web框架，详见 [http://www.yesodweb.com/](http://www.yesodweb.com/)）
